...
- [2026-08-18] celladix.co.kr JS 폴링(setInterval) → MutationObserver/이벤트 기반 전환 (TBT)
- [2026-08-18] celladix.co.kr 썸네일 alt observer 감시 범위 축소 (TBT)
- [2026-08-18] celladix.co.kr 장바구니 버튼 바인딩 observer 9개 → 1개 통합 (TBT)
- [2026-08-18] celladix.co.kr JS 인라인 스크립트 위치 이동 (렌더링 블로킹 → FCP)
- [2026-08-18] celladix.co.kr MutationObserver 3개 → 1개 통합 (TBT)
- [2026-08-18] celladix.co.kr CSS 셀렉터 중괄호 누락 수정 (스타일 깨짐)
- [2026-08-18] celladix.co.kr .view_cnt 애니메이션 top→transform 전환 (리플로우/메인스레드)
- [2026-08-18] celladix.co.kr transition: all → 특정 속성 지정 (렌더링 비용, .title i / .deal100 button)
- [2026-08-18] celladix.co.kr 중복 CSS 규칙 정리 — .npay_btn_link.npay_btn_pay, .fixed_timer.mo_only (파일 용량)
- [2026-08-18] celladix.co.kr vsc-controller 규칙 3중 → 1개 병합 (파일 용량)
- [2026-08-18] celladix.co.kr console.log / 디버그 주석 제거 (파일 용량)
- [2026-08-18] celladix.co.kr 상세페이지 배너 WebP 변환 (LCP)
- [2026-08-20] curicell.kr 상단 header에 불필요해 숨김처리 된 .xans-layout-shoppinginfo 요소 제거(주석처리)
- [2026-08-24] cleanery.co.kr 상품 썸네일 width/height 명시 -> aspect-ratio: 1/1;  (CLS)
- [2026-08-24] cleanery.co.kr main_vis setTimeout 제거 + 조건부 초기화 (CLS)
- [2026-08-24] cleanery.co.kr 갤러리 Swiper 조건부 초기화 (TBT)
- [2026-08-24] cleanery.co.kr 카카오 트래킹 setInterval 무한폴링 수정 (TBT)
- [2026-08-24] cleanery.co.kr snap_combine_script async/defer 중복 속성 제거 (TBT)
- [2026-08-24] cleanery.co.kr txt_rv min-height 고정 (CLS)
- [2026-08-24] cleanery.co.kr txt_review.js 셀렉터 오류 수정 (안정성)
- [2026-08-24] cleanery.co.kr lozad.js head 하단 이동 + defer (LCP)
