...
- [2026-08-18] curicell.kr JS 인라인 스크립트 위치 이동 (렌더링 블로킹 → FCP)
- [2026-08-18] curicell.kr MutationObserver 3개 → 1개 통합 (TBT)
- [2026-08-18] curicell.kr CSS 셀렉터 중괄호 누락 수정 (스타일 깨짐)
- [2026-08-18] curicell.kr .view_cnt 애니메이션 top→transform 전환 (리플로우/메인스레드)
- [2026-08-18] curicell.kr transition: all → 특정 속성 지정 (렌더링 비용, .title i / .deal100 button)
- [2026-08-18] curicell.kr 중복 CSS 규칙 정리 — .npay_btn_link.npay_btn_pay, .fixed_timer.mo_only (파일 용량)
- [2026-08-18] curicell.kr vsc-controller 규칙 3중 → 1개 병합 (파일 용량)
- [2026-08-18] curicell.kr console.log / 디버그 주석 제거 (파일 용량)
- [2026-08-18] curicell.kr 상세페이지 배너 WebP 변환 (LCP)
